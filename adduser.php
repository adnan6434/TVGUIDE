...
?>
<form id="add_form" method="POST" action="adduser.php">
	<fieldset>
	...
	<?php if(isset($_GET['error'])): ?>
		...
		<p>
			...
			<input type="number" name="roleid" value="2" required="true" min='1' max="2" value="1" step="1">
		<p>
			
		</p>

<p>
	<input type="submit" value="register" name="adminregister">
</p>
</fieldset>
	</form>
