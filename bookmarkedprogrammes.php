...
<H6> <?php echo $login_user;?>  Your Bookmarked Programmes are!!!!</H6>
<?php
$sql="SELECT distinct ProgrameName from programmebookmark,user,programme where programmebookmark.UserID=$usid and programmebookmark.ProgrammeID=programme.ProgrammeID";
