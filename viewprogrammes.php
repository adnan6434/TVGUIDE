...
$sql4= "SELECT * FROM `timeslot` where TimeslotID=$ts";
$r4=mysqli_query($conn,$sql4);
$f4=mysqli_fetch_assoc($r4) ;
$id=$f['ProgrammeID'];
echo "<tr >";
...
echo "<td>".$f['ProgrammeDescription']."</td>";
echo "<td>".$f4['SlotDuration']."</td>";
echo "<td>".$f['ProgrammeTime']."</td>";
echo "<td>"."<a href='programmeupdate.php?pid=".$id."'>"."EDIT"."</a></td>";
echo "</tr>";
